...
export default function DocsLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      {/* Top Header */}
      <header className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-white/[0.06] bg-[#0a0a0a]/80 backdrop-blur-xl flex items-center px-6">
      ...
      <div className="flex pt-14">
        {/* Sidebar */}
        <aside className="fixed top-14 left-0 bottom-0 w-72 border-r border-white/[0.06] bg-[#0a0a0a] overflow-y-auto hidden lg:block">
          {/* Search */}
